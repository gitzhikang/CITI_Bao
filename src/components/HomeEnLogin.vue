<template>
  <foo name="en-login" transition="pop-out" :width="modalWidth" :focus-trap="true" :height="400">
    <div class="box">
      <div class="box-part" id="bp-left">
        <div class="partition" id="partition-register">
          ...
          <div class="partition-form">
            ...
            <button class="large-btn enterprise-btn" @click="enterpriseRegister"><span>企业注册</span></button>
          </div>
        </div>
      </div>
